...
def compute_msc(subject_data, fs=256, nperseg=256):
    ...
    # Use the first 19 electrodes for the MSC computation
    numElectrodes = 19  # Limit to the first 19 electrodes
    numTrials = subject_data.shape[1]
    msc = {field: np.zeros((numElectrodes, numElectrodes, numTrials)) for field in idx}
...
save_dir = r"C:\Users\uceerjp\Desktop\PhD\Year 2\DeepLearning-on-ALS-MI-Data\Graphs\Understanding Stability in Graphical Representation\GAT\adjAsX\Session 1 v X Pairs\ALS\Explain\MSC"
